    ...
    <div className=' bg-heading font-plus' data-aos="fade-up">
      <div className='sm:flex sm:flex-wrap p-[5%] min-[1176px]:grid grid-flow-col '>
        <div className='p-2 m-2'>
          ...
          <div className='w-[255px] -mt-3' ><p className='text-text pb-4 mb-4 text-sm leading-8'>Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis deserunt.</p></div>
