  ...
  return (
    <>
      ...
      <div className='flex justify-between items-center p-4 bg-white relative z-50 md:sticky md:top-0 md:left-0  shadow-sm'>
        ...
        {/* menubar */}
        <div onClick={toggleMenu} className='ease-linear duration-300 lg:hidden'>
          <FontAwesomeIcon icon={open ? faClose : faBars} className='text-primary text-2xl' />
        </div>

        {/* nav bar */}
        <div
          className={`${open ? 'visible translate-x-0 ' : 'invisible translate-x-60'} absolute z-20 top-16 right-0 bg-heading w-[60%] h-screen lg:h-auto text-text lg:block p-4 ease-linear duration-300 lg:visible lg:static lg:bg-transparent lg:w-auto lg:translate-x-0 lg:p-0 lg:z-auto`}>
          <nav>
            <ul className='lg:flex'>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">Home</Link></li>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">About Us</Link></li>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">Services</Link></li>
              <li
                ...
                <div
                 ...
                 ${click ? 'visible h-12 opacity-100 duration-200' : 'invisible'} `}>
                  <Link to="" className='lg:py-2'>Videos</Link>
                  <Link to="" className='lg:py-2'>Notes</Link>
                </div>
              </li>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">Blog</Link></li>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">Gallary</Link></li>
              <li className=' py-2 border-b-2 font-medium lg:py-0 lg:border-none lg:px-2 lg:mx-2'><Link to="">Contact</Link></li>
            </ul>
          </nav>
        </div>
